...
public class Leno1 extends javax.swing.JFrame {
    ...
    public Leno1() {
        ...
        String text="<html>";
        text+="Lenovo 2022 Newest Ideapad 3<br>" +
        "Laptop, 15.6  HD Touchscreen,<br>" +
        ...
        lab1.setText(text);
        String text2="<html>";
        text2+="2022 Newest Lenovo Ideapad 3<br>" +
        "Laptop, 15.6  HD Touchscreen,<br>" +
        "11th Gen Intel Core i3-1115G4<br>" +
        "Processor,<br>" +
        "8GB DDR4 RAM, 256GB PCIe<br>" +
        "NVMe SSD, HDMI, Webcam, Wi-Fi<br>" +
        "5, Bluetooth,<br>" +
        ...
        lab2.setText(text2);
         try {
            ...
            while(res.next()){
                if(res.getInt(3) == 13 && res.getBoolean(5) == true && res.getString(2).equals(ob.username)){
                    save1.setSelected(true);  
                }
                if(res.getInt(3) == 14 && res.getBoolean(5) == true && res.getString(2).equals(ob.username)){
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/lenovo1.png"))); // NOI18N

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imgs/lenovo2.png"))); // NOI18N
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(lab1, javax.swing.GroupLayout.DEFAULT_SIZE, 290, Short.MAX_VALUE)
